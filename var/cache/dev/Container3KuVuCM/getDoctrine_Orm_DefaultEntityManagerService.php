...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\MatchsRepository' => function () {
    return ($this->privates['App\Repository\MatchsRepository'] ?? $this->load('getMatchsRepositoryService.php'));
}, 'App\\Repository\\TeamsRepository' => function () {
    return ($this->privates['App\Repository\TeamsRepository'] ?? $this->load('getTeamsRepositoryService.php'));
}))));
