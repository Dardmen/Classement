...
// Returns the private 'App\Repository\TeamsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TeamsRepository.php';

return $this->privates['App\Repository\TeamsRepository'] = new \App\Repository\TeamsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
